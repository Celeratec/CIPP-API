function Invoke-ExecRestoreDeletedSite {
    ...
    try {
        ...
        $RestoreUri = "$($SharePointInfo.AdminUrl)/_api/SPO.Tenant/RestoreDeletedSite"
        ...
        $Results = "Successfully restored SharePoint site '$SiteLabel' from the recycle bin."
        ...
        $Results = "Failed to restore SharePoint site '$SiteUrl'. Error: $ErrorText"
