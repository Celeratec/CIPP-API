function Invoke-CIPPStandardGlobalQuarantineNotifications {
    ...
    $TestResult = Test-CIPPStandardLicense -StandardName 'GlobalQuarantineNotifications' -TenantFilter $Tenant -Preset Exchange #No Foundation because that does not allow powershell access
